...
function get\u0076\u006c\u0065\u0073\u0073Config(userID, hostName) {
  ...
  const note = `认准无渺Tech官方节点\n完全免费提供节点，解锁YouTube、ChatGPT、X\n推荐客户端下载：\nv2rayN(GitHub Releases):https://github.com/2dust/v2rayN/releases(支持Windows10/11 macOS Linux)\nv2rayNG（GitHub Releases）：https://github.com/2dust/v2rayNG/releases\niOS用户自行去App Store转美区ID下载：Quantumult\nProxyIP使用nat64自动生成，无需设置`;
